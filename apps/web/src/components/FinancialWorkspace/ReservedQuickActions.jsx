...
/**
 * Reserved Quick Actions container.
 * Hidden by default when empty (no children / no items).
 */
export default function ReservedQuickActions({ title = 'Quick Actions', items, children }) {
  ...
  return (
    <section className="fw-reserved-panel fw-quick-actions" aria-label={title}>
