...
const SummaryReportView = () => {
    ...
    return (
        <div className="fade-in" style={{ padding: (activeTab === 'money-story' || activeTab === 'safety-net' || activeTab === 'future-self' || activeTab === 'executive') ? '0' : '2rem', maxWidth: (activeTab === 'money-story' || activeTab === 'safety-net' || activeTab === 'future-self' || activeTab === 'executive') ? '100%' : '1200px', margin: '0 auto' }}>
